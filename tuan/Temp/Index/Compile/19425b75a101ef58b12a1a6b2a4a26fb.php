...
<!-- 载入公共头部文件结束 -->
	<link href="http://localhost/SH_tuan/tuan/App/Index/Tpl//Public/css/detail.css" type="text/css" rel="stylesheet" >
	<div id="map" class='position'>
		<a href="<?php echo U('Index/Index/index');?>/lid/<?php echo $detail['lid'];?>"><?php echo $detail['lname'];?></a><span>»</span><a href="<?php echo U('Index/Index/index');?>/cid/<?php echo $detail['cid'];?>"><?php echo $detail['cname'];?></a><span>»</span><span><?php echo $detail['shopname'];?></span>
	</div>
	<div id="content" class='position'>
		...
		<div class='content-right'>
			<div class='recommend'>
				...
				<?php if(is_array($related)):?><?php  foreach($related as $v){ ?>
	...
	<script src="http://localhost/SH_tuan/tuan/App/Index/Tpl//Public/js/detail.js"> </script>
	<script>
	...
	<script>
		...
		var pos = <?php echo $detail['shopcoord'];?>;
