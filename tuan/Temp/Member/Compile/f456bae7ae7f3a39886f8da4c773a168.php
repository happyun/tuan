...
<body>
	...
	<!-- 载入公共头部文件-->
	<link href="http://localhost/SH_tuan/tuan/App/Member/Tpl//Public/css/cart.css" type="text/css" rel="stylesheet" >
	<script src="http://localhost/SH_tuan/tuan/App/Member/Tpl//Public/js/cart.js"></script>
	<div id="main">
		<?php if($cart){?>
		<div class='step'>
		...
		<?php  }else{ ?>
			没有添加到购物车的商品。<a href="http://localhost/SH_tuan">去看看</a> 
		<?php }?>
	</div>
</body>
</html>