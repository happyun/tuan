...
<body>
	...
	<!-- 载入公共头部文件-->
	<link href="http://localhost/SH_tuan/tuan/App/Member/Tpl//Public/css/reg.css" type="text/css" rel="stylesheet" >
	<script src="http://localhost/SH_tuan/tuan/App/Member/Tpl//Public/js/regCheck1.js"></script> 
	<script>
		function changeCode(){
			var src = '<?php echo U('Member/Reg/showCode');?>/mt/'+Math.random();
			$(this).attr('src',src);
		}
		var __JSCONTROL__ = 'http://localhost/SH_tuan/index.php/Member/Reg';
	</script>
