...
<div id="main">
	<div class='left'>
		...
		<div id="content">
		<link href="http://localhost/SH_tuan/tuan/App/Member/Tpl//Public/css/order.css" type="text/css" rel="stylesheet" >
		<div class='order-nav'>
			<a href="<?php echo U('Member/Order/index');?>" class='active'>全部</a>
			<a href="<?php echo U('Member/Order/index');?>/status/0">未付款</a>
			<a href="<?php echo U('Member/Order/index');?>/status/1">已付款</a>
		</div>
